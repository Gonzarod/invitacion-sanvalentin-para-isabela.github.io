function playMusic() {
  document.getElementById("saborami").play();
}
...
function showMessage(response) {
  ...
  if (response === "Yes") {
    ...
    yesMessage.textContent = "Te veo el 14 de febrero hermosa. Detalles al interno.";
    ...
    document.getElementById("yesButton1").remove();
    document.getElementById("yesButton2").remove();
  }
